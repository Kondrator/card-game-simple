...
namespace UIWindowManager{
	...
	public class UIWindowMenu : UIWindow, IListenerLoaderSceneCompleted {
		...
		[SerializeField]
		private LocalizedText	localizedExitGameQuestion = null;
		[SerializeField]
		private LocalizedText	localizedExit = null,
								localizedCancel = null;
		...
		public static void QuitGameTry(){
			...
			if( singleton.isQuitWithMessageBox == true ){
				...
				singleton.messageBoxQuit = UIMessageBox.CreateShow(	UIWindowMenu.singleton.localizedExitGameQuestion.Value, 
																	UIMessageBoxButtons.YesNo,
																	UIWindowMenu.singleton.localizedExit.Value, UIWindowMenu.singleton.localizedCancel.Value
																);
