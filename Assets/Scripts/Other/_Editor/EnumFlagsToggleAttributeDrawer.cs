...
[CustomPropertyDrawer( typeof( EnumFlagsToggleAttribute ) )]
public class EnumFlagsToggleAttributeDrawer : PropertyDrawer {
    ...
    void Initialize( SerializedProperty property ) {
        ...
        var fieldInfo = MyOperationClass.GetField( parentType, property.propertyPath );
