...
public static class MyOperationUI {
	...
	/// </summary>
	public static void FixSize( this Transform target, float offsetAll = 0 ){
	...
	/// Set local scale to one and set offset for RectTransform.
	/// </summary>
	public static void FixSize( this GameObject target, float offsetAll = 0 ){
		target.transform.FixSize( offsetAll );
	}
	public static void FixScale( this Transform target, float scale = 1 ){
		target.localScale = new Vector3( scale, scale, scale );
	}
	public static void FixScale( this GameObject target, float scale = 1 ){
